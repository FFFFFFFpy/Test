...
public class SubwaySystem {
    ...
    private void findAllPathsDFS(String currentStation, String endStation, Set<String> visited,
    ...
    public void test3() {
        ...
        if (payway.equals("单程票")) {
            ...
            System.out.println("价格为" + ticketCalculator.getprice(distances.get(linenumber)));
        }
        if (payway.equals("武汉通")) {
            System.out.println("您选择武汉通支付");
            Price price = new Price();
            System.out.println("价格为" + price.getprice(distances.get(linenumber)));
        }
